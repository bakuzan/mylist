...
function(c){var g,u=!0,p=[],h=d.maxTagCount(c),y=c.length;//is tag in array?
...
,itemHistory:function(c,u,p,g){//populate the history of when each part was 'checked' off.
...
var g,h,p=s(new Date);return s(c).toISOString().substring(0,10)===s(u).toISOString().substring(0,10)?(g=s(u),h=g.fromNow(),'a day ago'===h)?'Yesterday at '+g.format('HH:mm'):-1<h.indexOf('days')?h+' at '+g.format('HH:mm'):h+'.':(g=s(c),h=p.diff(g,'days'),0===h)?'Today':1===h?'Yesterday':h+' days ago.'},maxCompleteMonth:function(c){var u={},p=0;for(var g=0;g<c.length;g++)if(c[g].end!==void 0&&null!==c[g].end){var h=c[g].end.substring(0,7);null===u[h]||u[h]===void 0?u[h]=1:u[h]++,u[h]>p&&(p=u[h])}return p},maxTagCount:function(c){var u={},p=0;return angular.forEach(c,function(g){angular.forEach(g.tags,function(h){var y=h.text;null===u[y]||void 0===u[y]?u[y]=1:u[y]++,u[y]>p&&(p=u[y])})}),p},ratingsWeighted:function(c){var u=[],p=[],g=0,h=0;/**
	             ...
	             */for(var w in p)'function'==typeof p[w]||isNaN(p[w])||(g+=w*p[w],h+=p[w]),0===w&&p[w];/* Weighted average.
							 ...
							 */return g/h},setSeason:function(c,u,p){var g=r('endedSeason')(c,u,p);return angular.forEach(g,function(h){console.log(h.title),h.season=d.convertDateToSeason(new Date(h.start))}),g}};return d}angular.module('animeitems').service('ItemService',t),t.$inject=['moment','$filter','ListService']}(),function(){'use strict';function t(s,r){//Retrieve the item values for grouping by
...
var m={checkForTagless:function(u){var p=!1;return angular.forEach(u,function(g){0===g.tags.length&&(p=!0)}),p},concatenateTagArrays:function(u,p){if(0<u.length){for(var g=0,h=!1;g<p.length;){for(var y=0;y<u.length;y++)u[y].text===p[g].text&&(h=!0);//add if isn't already in the array.
...
,d.goToSlide=function(g){d.currentIndex===g?l.filteredSlides[d.currentIndex].locked?(l.filteredSlides[d.currentIndex].locked=!1,c()):(l.filteredSlides[d.currentIndex].locked=!0,s.cancel(m)):g===l.filteredSlides.length?d.currentIndex=0:d.currentIndex=g},d.interval=void 0===d.interval?3000:d.interval,d.isFullscreen=!1,d.leave=function(){!0!==l.filteredSlides[d.currentIndex].locked&&(m=s(c,d.interval))}//Fullscreen capability
...
for(var u=0;u<length;u++)d.slides.push({index:u})}l.$watch('sliderController.currentIndex',function(){-1<d.currentIndex&&0<l.filteredSlides.length&&(l.filteredSlides.forEach(function(p){p.visible=!1,p.locked=!1}),l.filteredSlides[d.currentIndex].visible=!0)}),c=function(){m=s(function(){d.next(),m=s(c,d.interval)},d.interval)},c(),l.$on('$destroy',function(){s.cancel(m)})}],link:function(l,d){l.childElementCount=d[0].childElementCount-1}}}angular.module('characters').directive('slider',t),t.$inject=['$timeout','$sce']}(),function(){'use strict';angular.module('characters').filter('mediaFilter',function(){return function(s,r){if(s!==void 0)return s.filter(function(l){return'anime'===r?null!==l.anime&&null===l.manga:'manga'===r?null!==l.manga&&null===l.anime:'both'===r?null!==l.anime&&null!==l.manga:'none'!==r||null===l.anime&&null===l.manga||void 0})}})}(),function(){'use strict';angular.module('characters').filter('seriesDetailFilter',function(){return function(s,r){if(s!==void 0)return s.filter(function(l){if(''===r)return l;//filter stat series detail.
...
,localStorage.setItem('theme',JSON.stringify(m.theme)),localStorage.setItem('timedTheme',JSON.stringify(m.timedTheme)),s.$on('$stateChangeSuccess',function(){m.isCollapsed=!1})}angular.module('core').controller('HeaderController',t),t.$inject=['$scope','Authentication','Menus','$location']}(),function(){'use strict';function t(s){return{restrict:'A',scope:{showBackdrop:'=ngShow'},link:function(r){var l=document.body,d=angular.element('<div id="anywhere-but-here-backdrop" ng-show="showBackdrop" ng-click="triggerAnywhereButHere()"></div>')[0];l.appendChild(d),s(d)(r),r.triggerAnywhereButHere=function(){r.showBackdrop=!1}}}}angular.module('core').directive('anywhereButHere',t),t.$inject=['$compile']}(),function(){'use strict';function t(s){return{restrict:'A',link:function(r,l,d){l.bind('click',function(m){s(function(){m.stopPropagation(),document.getElementById(d.clickPass).click()},0)})}}}angular.module('core').directive('clickPass',t),t.$inject=['$timeout']}(),function(){'use strict';angular.module('core').directive('formatDate',function(){return{require:'ngModel',link:function(s,r,l,d){d.$formatters.push(function(m){return null===m?null:new Date(m)})}}})}(),function(){'use strict';function t(s,r){return{restrict:'A',transclude:!0,replace:!0,templateUrl:'/modules/core/templates/loading-spinner.html',scope:{name:'@',size:'@?'},bindToController:'loadingSpinner',controller:['$scope',function(l){l.active=!1;//            $scope.isLoading = function () {
...
_register:function(d){if(!d.hasOwnProperty('name'))throw new Error('Spinner must specify a name when registering with the spinner service.');if(s.hasOwnProperty(d.name))throw new Error('A spinner with the name \''+d.name+'\' has already been registered.');s[d.name]=d,this.count++,r[d.name]&&(l[d.name]?(this[r[d.name]](d.name,l[d.name]),delete l[d.name],delete r[d.name]):(this[r[d.name]](d.name),delete r[d.name]))},_unregister:function(d){s.hasOwnProperty(d)&&delete s[d]},loading:function(d,m){if(!this.spinners[d])//            console.log('defer', loads[name]);
return r[d]='loading',void(l[d]=m);var c=s[d];c.show(d),m=m||{},(m.always||m['finally'])&&(m={promise:m});var u=angular.extend({},m);u.promise&&(u.promise.always?u.promise.always(function(){c.hide(d)}):u.promise['finally']&&u.promise['finally'](function(){c.hide(d)}))},show:function(d){//        console.log('show');
if(!this.spinners[d])return void(r[d]='show');var m=s[d];if(!m)throw new Error('No spinner named \''+d+'\' is registered.');m.show()},hide:function(d){//        console.log('hide');
if(!this.spinners[d])return void(r[d]='hide');var m=s[d];if(!m)throw new Error('No spinner named \''+d+'\' is registered.');m.hide()},toggle:function(d){//        console.log('toggle');
...
,T.findAnime=function(){T.animeitems=m.query()}//image upload
,T.imgPath='',T.itemUpdate=new Date,T.init=//for typeahead array.
function(){T.config.isCreate=S===void 0,T.config.isCreate?(T.mangaitem.episodes=0,T.mangaitem.start=T.itemUpdate,T.mangaitem.latest=T.itemUpdate,T.malSearchOptions.disabled=!1):!T.config.isCreate&&(T.config.title='Edit',T.findOne()),T.find(),T.findAnime()},T.malSearchOptions={placeholder:'Title',name:'title',required:!0,autocomplete:'off',disabled:!0},T.removeTag=function(A){$.dropTag(T.mangaitem.tags,A)},T.sections={showAdditional:!1,showCompletion:!1,showItemTags:!1},T.selectMalEntry=function(A){A?(T.mangaitem.title=A.title,T.mangaitem.finalChapter=A.chapters,T.imgPath=A.image,T.mangaitem.mal={id:A.id}):(T.mangaitem.finalChapter=0,T.mangaitem.mal=void 0)},T.submit=function(){T.config.isCreate&&T.create(),T.config.isCreate||T.update()},T.tagArray=[],T.tagArrayRemove=[],T.update=function(){var A=T.mangaitem;T.mangaitem=void 0,w.update(A,T.tagArray,T.config.updateHistory,T.imgPath)},T.uploadFile=function(){T.imgPath='/modules/mangaitems/img/'+T.myFile.name,u.uploadFileToUrl(T.myFile,'/fileUpload')},T.usedTags=[],T.init()}angular.module('mangaitems').controller('CreateMangaController',t),t.$inject=['$scope','$stateParams','$location','Authentication','Animeitems','Mangaitems','fileUpload','$sce','$window','ItemService','ListService','NotificationFactory','MangaFactory','spinnerService','TagService','Enums']}(),function(){'use strict';function t(s,r,l,d,m,c,u,p,g,h,y,v,w,C){var $=this;$.authentication=d,$.filterConfig={showingCount:0,sortType:'',sortReverse:!0,ratingLevel:void 0,ratingActions:{maxRating:10,percent:void 0,overStar:null},searchTags:'',tagsForFilter:[],taglessItem:!1,areTagless:!1,selectListOptions:{},statTags:[],viewItem:''},$.find=// Find a list of Mangaitems
function(){$.filterConfig.selectListOptions=h.getSelectListOptions($.whichController),w.loading('manga',m.query().$promise.then(function(S){$.mangaitems=S,$.filterConfig.areTagless=h.checkForTagless(S),$.filterConfig.statTags=g.buildStatTags(S,0)}))},$.findOne=// Find existing Mangaitem
function(){m.get({mangaitemId:r.mangaitemId}).$promise.then(function(S){$.mangaitem=S})},$.latestDate=//latest date display format.
...
,C.tickOffChecklist=function(I,A){g.tickOffChecklist(I,A).then(function(x){x.refresh&&w()})},C.updateTask=function(I){g.updateTask(I)},C.weekBeginning=function(){return g.getWeekBeginning()},C.whichController='task',C.setTabFilterDay(T),w(!0)}angular.module('tasks').controller('TasksController',t),t.$inject=['$scope','$timeout','$stateParams','$location','Authentication','Tasks','ListService','NotificationFactory','TaskFactory','spinnerService','$uibModal','moment']}(),function(){'use strict';function t(s,r,l,d){var m=this;m.cancel=function(){r.dismiss('cancel')},m.episodeCompleted=l.item.link.anime.episodes+1,m.episodeNumber=d.pad(m.episodeCompleted,3),m.episodeRating=0,m.item=l.item,m.isComplete=m.episodeCompleted===m.item.link.anime.finalEpisode&&0!==m.item.link.anime.finalEpisode,m.ratingLimit=10,m.stepConfig={currentStep:1,stepCount:1},m.submit=function(){r.close({task:m.item,episodeRating:m.episodeRating})}}angular.module('tasks').controller('UpdateAnimeTaskController',t),t.$inject=['$scope','$uibModalInstance','data','FunctionService']}(),function(){'use strict';function t(s,r,l){var d=this;d.cancel=function(){r.dismiss('cancel')},d.item=l.item,d.stepConfig={currentStep:1,stepCount:1},d.submit=function(){r.close(d.item)},console.log('update linked manga item: ',d.item)}angular.module('tasks').controller('UpdateMangaTaskController',t),t.$inject=['$scope','$uibModalInstance','data']}(),function(){'use strict';function t(s){return{restrict:'A',link:function(r,l){l.data('interesting',!0),angular.element(s[0].body).on('click',function(d){var m=angular.element(d.target).inheritedData('interesting'),c=angular.element(d.target)[0].tagName;//console.log(elm);
m||'A'===c||'I'===c||r.$apply(function(){r.collapseFilters()})})}}}t.$inject=['$document','$window'],angular.module('tasks').directive('loseInterest',t)}(),function(){'use strict';function t(s,r,l){function d(p){return p.day(1).hour(12).minute(0).second(0).millisecond(0)}function m(p,g,h){p.weeks=[];for(var y=!1,v=r(g),w=v.month(),C=0;!y;){var $=c(r(v),h);-1<l.findWithAttr($,'isCurrentMonth',!0)&&p.weeks.push({days:$}),v.add(1,'w'),y=2<C++&&w!==v.month(),w=v.month()}}function c(p,g){var h=[];for(var y=0;7>y;y++)h.push({name:p.format('dd').substring(0,1),number:p.date(),isCurrentMonth:p.month()===g.month(),isToday:p.isSame(new Date,'day'),date:p}),p=r(p),p.add(1,'d');return h}function u(p,g,h){s.open({animation:!0,templateUrl:'/modules/tasks/views/schedule-calendar-task.client.view.html',controller:'ScheduleCalendarTaskController as ctrl',size:'lg',resolve:{data:function(){return{events:p,date:g,days:h}}}}).result.then(function(y){console.log('closed - require refresh: ',y)})}return{restrict:'A',templateUrl:'modules/tasks/templates/schedule-calendar.html',scope:{events:'='},link:function(p){p.days=[{text:'Mon'},{text:'Tue'},{text:'Wed'},{text:'Thu'},{text:'Fri'},{text:'Sat'},{text:'Sun'}],p.selected=r(new Date),p.month=r(p.selected);var g=r(d(angular.copy(p.selected)));g.date(-6),d(g.day(0)),m(p,g,p.month),p.select=function(h){p.selected===h.date&&u(p.events,h.date,p.days),p.selected=h.date},p.next=function(){var h=r(p.month);d(h.month(h.month()+1).date(0)),p.month.month(p.month.month()+1),m(p,h,p.month)},p.previous=function(){var h=r(p.month);d(h.month(h.month()-1).date(0)),p.month.month(p.month.month()-1),m(p,h,p.month)}}}}angular.module('tasks').directive('scheduleCalendar',t),t.$inject=['$uibModal','moment','ListService']}(),function(){'use strict';angular.module('tasks').directive('shadowModel',function(){return{scope:!0,link:function(s,r,l){console.log('shadow: ',s),s[l.shadow]=angular.copy(s[l.shadow])}}})}(),function(){'use strict';angular.module('tasks').directive('taskItemModel',function(){return{restrict:'A',replace:!0,templateUrl:'modules/tasks/templates/task-item.html'}})}(),function(){'use strict';angular.module('tasks').directive('passClick',function(){return{restrict:'A',link:function(s,r,l){r.bind('click',function(){var d=document.getElementById(l.passClick);d.focus(),d.click()})}}})}(),function(){'use strict';function t(s,r,l,d,m,c,u,p){function g(w,C){if(w){for(var $ in w.$remove(),C)C[$]===w&&C.splice($,1);c.warning('Deleted!','Task was successfully deleted.')}}//Linked manga need special options dialog.
...
if(F=T.topten.conditions.series.length,null!==P){// console.log('tag item: ', ctrl.stepConfig.listGen.items[i]);
for(O=0;O<F;O++){var E=T.topten.conditions.series[O];// console.log(ctrl.stepConfig.listGen.items[i][attr].title, series.name, ctrl.stepConfig.listGen.items[i][attr].title.indexOf(series.name));
...
if(F=T.topten.conditions.tags.length,0<T.stepConfig.listGen.items[M].tags.length){// console.log('tag item: ', ctrl.stepConfig.listGen.items[i].tags);
for(O=0;O<F;O++){var D=T.topten.conditions.tags[O];// console.log('tag round: ' + i + '-' + j, ctrl.stepConfig.listGen.items[i].tags, tag.tag, ListService.findWithAttr(ctrl.stepConfig.listGen.items[i].tags, 'text', tag.tag));
-1<c.findWithAttr(T.stepConfig.listGen.items[M].tags,'text',D.tag)&&U++}U!==F&&T.stepConfig.listGen.items.splice(M,1)}else T.stepConfig.listGen.items.splice(M,1)}// console.log('post conditions: ', ctrl.stepConfig.listGen.items.length, ctrl.stepConfig.listGen.itemsCached.length);
...
function(v){u.confirmation(function(){if(v)for(var w in v.$remove(),h.toptens)h.toptens[w]===v&&h.toptens.splice(w,1);else h.topten.$remove(function(){l.path('toptens')});u.warning('Deleted!','Anime was successfully deleted.')})},h.viewConfig={displayType:'',linkSuffix:'',tags:[],series:[]},h.whichController='topten'}angular.module('toptens').controller('ToptensController',t),t.$inject=['$scope','$stateParams','$location','Authentication','$uibModal','Toptens','NotificationFactory','ListService','spinnerService']}(),function(){'use strict';angular.module('toptens').directive('horizontalListItem',function(){return{restrict:'A',replace:!0,transclude:!0,scope:{},templateUrl:'/modules/toptens/templates/horizontal-list-item.html',require:'^horizontalList',link:function(s,r,l,d){s.isVisible=!1,s.itemWidth=d.itemWidth,s.position=r.index(),d.register(s)}}})}(),function(){'use strict';angular.module('toptens').directive('horizontalList',function(){return{restrict:'A',transclude:!0,require:'horizontalList',scope:{},templateUrl:'/modules/toptens/templates/horizontal-list.html',bindToController:!0,controllerAs:'horizontalList',controller:['$scope',function(){function s(){var l=[],d=3*r.clicks;for(var m=0;3>m;m++)l.push(d+m);angular.forEach(r.items,function(c){c.isVisible=-1<l.indexOf(c.position)})}var r=this;r.clicks=0,r.items=[],r.moveItems=function(d){'left'===d?(0>r.clicks-1?r.clicks=0:r.clicks-=1,s()):'right'==d&&(r.clicks+1<Math.ceil(r.items.length/3)&&(r.clicks+=1),s())},r.register=function(d){r.items.push(d),-1<[0,1,2].indexOf(d.position)&&(d.isVisible=!0)},r.shift=0}],link:function(s,r,l,d){function m(){d.shift=-c.offsetWidth,d.itemWidth=c.offsetWidth/3,angular.forEach(d.items,function(p){p.itemWidth=d.itemWidth})}var c=r[0],u=c.children[0];s.settings={child:u,style:u.style,value:0},m(),window.addEventListener('resize',function(){c.offsetWidth!==Math.abs(d.shift)&&(m(),s.$apply())})}}})}(),function(){'use strict';angular.module('toptens').directive('ngMax',function(){return{restrict:'A',require:'ngModel',link:function(s,r,l,d){s.$watch(l.ngMax,function(){d.$isDirty&&d.$setViewValue(d.$viewValue)});var m=function(u){return angular.isUndefined(u)||''===u||null===u},c=function(u){var p=s.$eval(l.ngMax)||1/0;return!m(u)&&u>p?(d.$setValidity('ngMax',!1),void 0):(d.$setValidity('ngMax',!0),u)};d.$parsers.push(c),d.$formatters.push(c)}}})}(),function(){'use strict';angular.module('toptens').directive('ngMin',function(){return{restrict:'A',require:'ngModel',link:function(s,r,l,d){s.$watch(l.ngMin,function(){d.$isDirty&&d.$setViewValue(d.$viewValue)});var m=function(u){return angular.isUndefined(u)||''===u||null===u},c=function(u){var p=s.$eval(l.ngMin)||0;return!m(u)&&u<p?(d.$setValidity('ngMin',!1),void 0):(d.$setValidity('ngMin',!0),u)};d.$parsers.push(c),d.$formatters.push(c)}}})}(),function(){'use strict';angular.module('toptens').directive('oneStep',function(){return{restrict:'A',replace:!0,transclude:!0,scope:{},require:'^steps',templateUrl:'/modules/toptens/templates/step.html',link:function(s,r,l,d){s.active=!1,s.stepNumber=r.index()+1,d.register(s)}}})}(),function(){'use strict';angular.module('toptens').directive('stepControls',function(){return{restrict:'A',replace:!0,transclude:!0,template:'<div class="step-controls step-button-group padding-5" ng-transclude></div>'}})}(),function(){'use strict';angular.module('toptens').directive('steps',function(){return{restrict:'A',transclude:!0,scope:{stepConfig:'='},template:'<div class="steps" ng-transclude></div>',bindToController:!0,controllerAs:'steps',controller:['$scope',function(){var s=this;s.register=function(l){s.steps.push(l),1===l.stepNumber&&(l.active=!0)},s.steps=[]}],link:function(s,r,l,d){s.$watch('steps.stepConfig.currentStep',function(m){m!==void 0&&(console.log('steps: ',m),angular.forEach(d.steps,function(c){c.active=!(c.stepNumber!==m)}))})}}})}(),function(){'use strict';angular.module('toptens').directive('sticky',function(){return{restrict:'A',scope:{},link:function(s,r){window.addEventListener('scroll',function(){var l='sticky-scroll-top',d='sticky-inner-container',m=document.body.scrollTop,c=r[0],u=c.children[0],p=c.getBoundingClientRect(),g=p.top;// This value is your scroll distance from the top
