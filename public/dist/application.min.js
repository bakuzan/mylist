...
var g,h,p=s(new Date);return s(c).toISOString().substring(0,10)===s(u).toISOString().substring(0,10)?(g=s(u),h=g.fromNow(),'a day ago'===h)?'Yesterday at '+g.format('HH:mm'):-1<h.indexOf('days')?h+' at '+g.format('HH:mm'):h+'.':(g=s(c),h=p.diff(g,'days'),0===h)?'Today':1===h?'Yesterday':h+' days ago.'},maxCompleteMonth:function(c){var u={},p=0;for(var g=0;g<c.length;g++)if(c[g].end!==void 0&&null!==c[g].end){var h=c[g].end.substring(0,7);null===u[h]||u[h]===void 0?u[h]=1:u[h]++,u[h]>p&&(p=u[h])}return p},maxTagCount:function(c){var u={},p=0;return angular.forEach(c,function(g){angular.forEach(g.tags,function(h){var y=h.text;null===u[y]||void 0===u[y]?u[y]=1:u[y]++,u[y]>p&&(p=u[y])})}),p},ratingsWeighted:function(c){var u=[],p=[],g=0,h=0;/**
	             ...
	             */for(var w in p)'function'==typeof p[w]||isNaN(p[w])||(g+=w*p[w],h+=p[w]),0===w&&p[w];/* Weighted average.
							 ...
							 */return g/h},setSeason:function(c,u,p){var g=r('endedSeason')(c,u,p);return angular.forEach(g,function(h){console.log(h.title),h.season=m.convertDateToSeason(new Date(h.start))}),g}};return m}angular.module('animeitems').service('ItemService',t),t.$inject=['moment','$filter','ListService']}(),function(){'use strict';function t(s,r){//Retrieve the item values for grouping by
...
//                }
//            });
var m={name:l.name,show:function(){l.active=!0},hide:function(){l.active=!1},toggle:function(){l.active=!l.active}};r._register(m),l.$on('$destroy',function(){r._unregister(l.name)})}]}}angular.module('core').directive('loadingSpinner',t),t.$inject=['$http','spinnerService']}(),function(){'use strict';function t(s,r){return{restrict:'A',replace:!0,scope:{type:'=malSearch',selectItem:'=malSearchSelect',searchString:'=malSearchModel',options:'=malSearchOptions'},controllerAs:'malSearchCtrl',bindToController:!0,templateUrl:'/modules/core/templates/mal-search.html',controller:['$scope',function(l){function m(u,p){s.search(u,p).then(function(g){d.searchResults=g,d.hasSearchResults=!0})}var c,d=this;d.displayActions=!1,d.displaySelectedItemActions=function(){d.displayActions=!0},d.hasFocus=!1,d.hasSearchResults=!1,d.processItem=function(p){d.selectItem(p),d.selectedItem=p},d.searchResults=[],d.selectedItem=null,d.selectedItemActions=[{displayText:'Remove selected',action:function(){d.processItem(null),d.searchString=void 0,d.displayActions=!1}},{displayText:'Display raw json',action:function(){d.displayRawJson=!0}}],d.toggleSearchDropdownOnFocus=function(p){r(function(){d.hasFocus='focus'===p.type},500)},l.$watch('malSearchCtrl.searchString',function(u){d.hasFocus=!0,u!==void 0&&2<u.length&&null===d.selectedItem&&!d.options.disabled&&(r.cancel(c),c=r(function(){m(d.type,u)},2000))}),l.$watch('malSearchCtrl.displayActions',function(u){u===void 0||u||(d.displayRawJson=u)})}]}}angular.module('core').directive('malSearch',t),t.$inject=['MalService','$timeout']}(),function(){'use strict';angular.module('core').directive('myProgress',function(){return function(s,r,l){s.$watch(l.myProgress,function(m){r.html('<div class="checklist-progress" style="width: '+m+'%;height: 100%"></div>')})}})}(),function(){'use strict';angular.module('core').filter('calendarFilter',function(){return function(s,r){if(s)return s.filter(function(l){//date filter
